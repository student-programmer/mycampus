    ...
    <>
      ...
      <div className={l.form_box}>
          ...
          <CustomMultipleSelect
            ...
            onChange={(e) => {
              ...
              const selectedIds = selectedNames
                .map((name) => {
                  const selectedItem = LanguageList.find(
                    (item) => item.name === name
                  );
        ...
        <div>
          ...
          <CustomMultipleSelect
            ...
            onChange={(e) => {
              ...
              const selectedIds = selectedNames
                .map((name) => {
                  const selectedItem = InterestsList.find(
                    (item) => item.name === name
                  );
                  return selectedItem ? selectedItem.id : null;
                })
        ...
        <div>
          ...
          />
          {formik.errors.photo && (
            <ErrorComponent message={formik.errors.photo} />
          )}
        </div>
        <div>
          ...
          {formik.errors.location && (
            <ErrorComponent message={formik.errors.location} />
          )}
        </div>
        <div>
